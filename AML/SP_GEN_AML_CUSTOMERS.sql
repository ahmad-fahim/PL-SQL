CREATE OR REPLACE PROCEDURE SP_GEN_AML_CUSTOMERS (P_FROM_BRN    NUMBER,
                                                  P_TO_BRN      NUMBER)
IS
      ...
      BEGIN
         INSERT INTO AML_CUSTOMERS
            SELECT CLIENTS_CODE CUSTOMERNO,
                   ...
                   CLIENTS_HOME_BRN_CODE CBSBRANCHCODE,
                   NULL SERVICETYPE,
                   NULL SCRCUSTOMERTYPE,
                   ...
                   CLIENTS_LAST_MOD_ON LASTUPDATEDATE,
                   CLIENTS_ENTD_ON ENTRYDATE,
                   CASE WHEN CLIENTS_TYPE_FLG = 'I' THEN 'Ind' ELSE 'Ent' END
                      CUSTOMERTYPE,
         ...
         INSERT INTO AML_TRANSACTIONS
            ...
            || ',
                     ...
                     WHERE     TRAN_ENTITY_NUM = 1
                           ...
                           AND TRAN_BRN_CODE = ' || IDX.BRANCH_CODE || ') TR
                   LEFT OUTER JOIN
                   CTRAN'
            || V_FIN_YEAR
            || '
                      ON (    CTRAN_ENTITY_NUM = 1
                          ...
                          AND POST_TRAN_BRN = ' || IDX.BRANCH_CODE || ') ';
