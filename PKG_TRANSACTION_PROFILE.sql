CREATE OR REPLACE PACKAGE PKG_TRANSACTION_PROFILE
IS
...
IS
   ...
   (
      ...
      ACNTTRANPAMT_PROCESS_DATE        DATE,
   ...
   BEGIN
      V_SQL :=
        ...
        TO_CHAR(:V_ASON_DATE,''MON'') ACNTTRANPAMT_MONTH, :V_ASON_DATE ACNTTRANPAMT_PROCESS_DATE,
      ...
      --DBMS_OUTPUT.PUT_LINE (V_SQL || V_SQLSTRING);
            ...
            MERGE INTO ACNTTRANPROFAMT A
                 USING (SELECT W_NEW_TABLE (I).ACNTTRANPAMT_ENTITY_NUM
                               ...
                               W_NEW_TABLE (I).ACNTTRANPAMT_MONTH
                                  ACNTTRANPAMT_MONTH,
                               W_NEW_TABLE (I).ACNTTRANPAMT_PROCESS_DATE
                                  ACNTTRANPAMT_PROCESS_DATE,
     ...
     WHERE     H.ACBALH_ENTITY_NUM = A.ACBALH_ENTITY_NUM
       ...
       SELECT TRAN_ENTITY_NUM,
         ...
         FROM (  SELECT TRAN_ENTITY_NUM,
               ...
               GROUP BY TRAN_ENTITY_NUM, TRAN_INTERNAL_ACNUM)';
