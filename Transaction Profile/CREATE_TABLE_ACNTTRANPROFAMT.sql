ALTER TABLE ACNTTRANPROFAMT
 DROP PRIMARY KEY CASCADE;

DROP TABLE ACNTTRANPROFAMT CASCADE CONSTRAINTS;
...
CREATE UNIQUE INDEX PK_ACNTTRANPROFAMT ON ACNTTRANPROFAMT
...
ALTER TABLE ACNTTRANPROFAMT ADD (
  CONSTRAINT PK_ACNTTRANPROFAMT
  PRIMARY KEY
  (ACNTTRANPAMT_ENTITY_NUM, ACNTTRANPAMT_BRN_CODE, ACNTTRANPAMT_INTERNAL_ACNUM, ACNTTRANPAMT_MONTH, ACNTTRANPAMT_PROCESS_YEAR)
  USING INDEX PK_ACNTTRANPROFAMT
  ENABLE VALIDATE);
